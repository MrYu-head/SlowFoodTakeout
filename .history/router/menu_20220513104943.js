        ...
        db.searchShop({shopName : shopName},function(result){
            if(result[0].length > 0){
                // if(result[0].shopName == shopName){
                    // 查询商家信息成功
                    res.json({code : 666,message1:result[0].shopName,message2:result[0].minPrice,message3:result[0].address,message4:result[0].distance,message5:result[0].timeout})
                }
            }else{
